    ...
    <hr>
            ...
            <?php echo form_open('data/simpanpesanan') ?>
              ...
              <div class="form-group">
                ...
                <input type="text" name="Kd_pesanan" class="form-control" placeholder="Kode Pemesanan">
              </div>
              ...
              <div class="form-group">
                ...
                <select name="Kd_paket" class="form-control">
                    ...
                    <?php 
                    $sql = $this->db->get('paket_oubond');
                    foreach ($sql->result() as $row) {
                    ?>
                    <option value="<?php echo $row->Kd_paket ?>"><?php echo $row->Kd_paket ?></option> 
                    <?php } ?>
                </select>
