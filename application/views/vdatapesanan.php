...
<div class="wrapper">
  ...
  <div class="content-wrapper">
   ...
   <div class="container" style="margin-top: 20px">
            ...
            <!-- <a href="<?php echo base_url('data/tambahpemesanan') ?>" class="btn btn-secondary btn-sm">Tambah Data</a> -->
            <!-- <a href="<?php echo base_url('excel/form') ?>" class="btn btn-sm btn-success">Import</a>  -->
        <h3><center>Pemesanan paket</center></h3>
        <hr>
        <!-- table -->
        <div class="table-responsive">
            <table id="table" class="table table-striped table-bordered table-hover">
                ...
                <?php
                    ...
                    $pemesanan->Tgl_pemesanan = date('d F Y', strtotime($pemesanan->Tgl_pemesanan));
                ?>

                  <tr>
                    <td><?php echo $no++ ?></td>
                    <!-- <td><?php echo $pemesanan->Kode_pemesanan ?></td> -->
                    <td><?php echo $pemesanan->Kd_paket ?></td>
                    <td><?php echo $pemesanan->Tgl_pemesanan ?></td>
                    <td><?php echo $pemesanan->Jml_peserta ?></td>
                    <td><?php echo "Rp ".$pemesanan->Total_harga ?></td>
                    <td>
                        <!-- <a href="<?php echo base_url('data/editpemesanan/') ?><?php echo $pemesanan->Id_pemesanan ?>" class="btn btn-sm btn-warning" >Edit</a> -->                         
                        <a href="<?php echo base_url('data/hapuspemesanan/') ?><?php echo $pemesanan->Id_pemesanan ?>" class="btn btn-sm btn-danger">Hapus</a>
                    </td>
                  </tr>
