...
<div class="wrapper">
  ...
  <div class="content-wrapper">
   ...
   <div class="container" style="margin-top: 20px">
        ...
        <h3><center>Data Wisatawan</center></h3>
        <hr>
        <!-- table -->
        <div class="table-responsive">
            <table id="table" class="table table-striped table-bordered table-hover">
                ...
                <?php
                    $no = 1;
                    foreach($data_wisatawan as $wis){ 
                ?>

                  <tr>
                    <td><?php echo $no++ ?></td>
                    <td><?php echo $wis->nama ?></td>
                    <td><?php echo $wis->nama_instansi ?></td>
                    <td><?php echo $wis->alamat ?></td>
                    <td><?php echo $wis->email ?></td>
                    <td><?php echo $wis->no_telp ?></td>
                    <td>
                        <!-- <a href="<?php echo base_url('data/edit/') ?><?php echo $paket->Id_paket ?>" class="btn btn-sm btn-warning" >Edit</a>             -->             
                        <a href="<?php echo base_url('data/hapuswisatawan/') ?><?php echo $wis->id_wisatawan ?>" class="btn btn-sm btn-danger">Hapus</a>
                    </td>
                  </tr>
